...
Both month and day of week enter as factors using dummy variable encoding, 
with January and Sunday as the respective reference categories. The 
coefficients $\gamma_m$ and $\delta_d$ therefore represent the difference 
in expected daily count relative to January and Sunday respectively, 
holding all other predictors fixed. This also explains why both sums begin 
at $m = 2$ and $d = 2$ — the first level of each factor is absorbed into 
