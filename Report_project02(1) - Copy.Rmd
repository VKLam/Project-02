...
kable(trend_comparison,
      caption = "Comparison of M3 trend estimates with and without a COVID indicator.", booktabs = TRUE,
      linesep = "")
```
...
kable(threshold_15000,
      caption = "Earliest projected date at which predicted summer weekday demand exceeds 15,000 cyclists/day.", booktabs = TRUE,
      linesep = "")
```
...
kable(head(poor_period_table, 10),
      caption = "Months with the largest RMSE under the final model.", booktabs = TRUE,
      linesep = "")
